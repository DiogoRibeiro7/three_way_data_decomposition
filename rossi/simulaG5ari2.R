# simulaG5ari2 function: Simulate ARI results and save to a file
#
# This function simulates ARI (Adjusted Rand Index) results for a specified
# number of scenarios and saves the results to a file named 'G5ari2.RData'.
#
...
#
# Returns:
#   None. The results are saved to 'G5ari2.RData'.

simulaG5ari2 <- function() {
  ns <- 250
